...
- [Current Thing](https://github.com/GildedPleb/eslint-config-current-thing) - An unopinionated, purpose agnostic config based on the most downloaded ESLint configs: may the most popular rules win!
