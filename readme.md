...
- [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  - [eslint-plugin-tsconfig](https://github.com/Nick2bad4u/eslint-plugin-tsconfig) - Catch bad tsconfig compiler-option combinations and project reference drift before `tsc`.
