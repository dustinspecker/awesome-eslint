...
- [Code Quality Resources](https://github.com/gajus/eslint-config-canonical) - Collection of hand-crafted ESLint configurations for [Web](https://github.com/code-quality-resources/eslint-config-react), [React Native](https://github.com/code-quality-resources/eslint-config-react-native) and [Node](https://github.com/code-quality-resources/eslint-config-node) applications. Optional [Typescript](https://github.com/code-quality-resources/eslint-config-typescript) support and some more.
