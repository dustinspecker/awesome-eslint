...
- [eslint-plugin-repo](https://github.com/Nick2bad4u/eslint-plugin-repo) - ESLint rules for repository compliance across common code hosting and deployment platforms.
